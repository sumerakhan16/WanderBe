        ...
        <div class="modal-body" style="border-style: ridge; margin: 5%;  " >
          <form>
            ...
            <div class="form-group">
              ...
              <input type="text"  class="form-control"placeholder="Example: Tony's Diner" id="act-name">
            </div>
            <div class="form-group">
              <label for="message-text" class="col-form-label line" >Notes</label>
              <textarea class="form-control" placeholder= "Example: Great reviews on the lobster" id="act-notes"></textarea>
            </div>
            <div class="form-group">
              <label for="message-text" class="col-form-label line">Resources URL</label>
              <textarea class="form-control" placeholder="Menu Link" id="res-url"></textarea>
            </div>
