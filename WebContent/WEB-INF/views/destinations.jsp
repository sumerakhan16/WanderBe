        ...
        <div class="modal-body" style="border-style: ridge; " >
          ...
          <form:form action="addDestinations" method="post" modelAttribute="destinations" id="dest">
            ...
            <div class="form-group">
              ...
              <input name= "dName" type="text"  class="form-control"placeholder="Example: Florida" id="act-name">
            </div>
            <div class="form-group">
              <label for="message-text" class="col-form-label line">Image URL</label>
              <textarea name="dImageUrl" class="form-control" placeholder="Copy and Paste Image Address" id="res-url"></textarea>
              </div>
             <div class="modal-footer">
            <input  form="dest" type="submit" style="background-color: rgba(166, 221, 255, 0.728); width:10%"  id="save" class="btn btn-primary">
             </div>
             </form:form>   
            </div>
         </div>
