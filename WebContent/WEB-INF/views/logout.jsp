...
<footer>
  <div class="card-body">
      <h3 style="font-family: 'Berkshire Swash', cursive; font-family: 'Chango', cursive; font-family: 'Dancing Script', cursive; font-family: 'Paytone One', sans-serif; padding-top: 10%;">We don't want to see you go...</h3>
    <h3 style="font-family: 'Berkshire Swash', cursive; font-family: 'Chango', cursive; font-family: 'Dancing Script', cursive; font-family: 'Paytone One', sans-serif; padding-bottom: 10%;">Come back soon to continue planning your dream vacations!</h3>
